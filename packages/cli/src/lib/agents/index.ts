...
export interface AIAgentTool {
    ...
    expandTask(briefDescription: string, projectPath: string): Promise<IPromptTask | null>;
    
    // Expand iteration instructions based on previous work
    expandIterationInstructions(instructions: string, previousPlan?: string, previousChanges?: string): Promise<IPromptTask | null>;
